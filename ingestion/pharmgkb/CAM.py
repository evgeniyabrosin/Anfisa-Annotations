...
clinical_ann_metadata.tsv     CAM

COLUMN                      COLUMN NAME         TYPE
Clinical Annotation Id      CAID                INT(10)
Location                    LOC                 TEXT
Gene                        GEN                 VARCHAR(167)
...
INSTR_CREATE = """CREATE TABLE IF NOT EXISTS CAM(
    CAID                INT(10),
    LOC                 TEXT,
    GEN                 VARCHAR(167),
    LOE                 VARCHAR(2),
...
INSTR_INSERT = "INSERT INTO CAM (%s) VALUES (%s)" % (
    ", ".join(COLUMNS),
...
#========================================
def ingestCAM(db_host, db_port, user, password, database,
        batch_size, filename):
