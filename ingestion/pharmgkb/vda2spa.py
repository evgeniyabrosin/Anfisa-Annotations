...
INSTR_CREATE = """CREATE TABLE IF NOT EXISTS PharmVDA2SPA (
    AID_VDA              INT(10),
    SPID_SPA             INT(10),
    CONSTRAINT meta_to_CA
    PRIMARY KEY(AID_VDA, SPID_SPA));"""
...
INSTR_INSERT = "INSERT INTO PharmVDA2SPA(%s) VALUES(%s)" % (
    ", ".join(COLUMNS),
...
#========================================
def ingestVDA2SPA(db_host, db_port, user, password, database,
        batch_size, filename):
