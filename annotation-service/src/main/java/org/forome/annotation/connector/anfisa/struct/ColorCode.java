...
public class ColorCode
{
    ...
    {
        System.out.println (code (Shape.CROSS, Color.YELLOW));
        System.out.println (code (Shape.CROSS, Color.RED));
        System.out.println (code (Shape.CIRCLE, Color.YELLOW));
        System.out.println (code (Shape.CIRCLE, Color.GREEN));
        System.out.println (code (Shape.CIRCLE, Color.RED));
    }
}
