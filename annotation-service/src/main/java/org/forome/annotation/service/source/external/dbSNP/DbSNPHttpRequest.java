...
package org.forome.annotation.service.source.external.dbSNP;
...
/**
 * curl -d '{"variants":[{"chrom":"chr1","pos":6484880}], "fasta":"hg19", "arrays":["dbSNP"]}' -H "Content-Type: application/json" -X POST "localhost:8290/collect"
 *
 * [{"chrom": "chr1", "pos": 6484880, "hg38": 6424820, "dbSNP": [{"ALT": "C,G", "REF": "A", "rs_id": "rs188079860"}]}]
 */
public class DbSNPHttpRequest {
	...
	public DbSNPHttpRequest(ExternalSource httpSource) {
	...
	public JSONArray get(Interval interval) throws URISyntaxException {
		...
		JSONArray jRecords = (JSONArray) response.get("dbSNP");
		return jRecords;
	}
}
