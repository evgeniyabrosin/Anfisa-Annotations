package ru.processtech.forome.annotation.config;

import net.minidev.json.JSONObject;
import net.minidev.json.parser.JSONParser;
import ru.processtech.forome.annotation.config.connector.ClinVarConfigConfigConnector;
import ru.processtech.forome.annotation.config.connector.GTFConfigConfigConnector;
import ru.processtech.forome.annotation.config.connector.GnomadConfigConfigConnector;
import ru.processtech.forome.annotation.config.connector.HgmdConfigConfigConnector;
