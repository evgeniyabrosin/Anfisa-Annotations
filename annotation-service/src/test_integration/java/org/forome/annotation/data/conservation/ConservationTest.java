...
public class ConservationTest extends AnfisaBaseTest {
	...
	public void testSimple() {
		...
		Conservation conservation1 = conservationConnector.getConservation(pos1, "G", "T");
		...
		Conservation conservation2 = conservationConnector.getConservation(pos2, "A", "C");
		...
		Conservation conservation3 = conservationConnector.getConservation(pos3, "G", "C");
		...
		Conservation conservation4 = conservationConnector.getConservation(pos4, "A", "G");
		...
		Conservation conservation5 = conservationConnector.getConservation(pos5, "GGCAGCGCCA", "G");
		...
		Conservation conservation7 = conservationConnector.getConservation(pos7, "A", "AACC");
	...
	public void testMulti() {
		...
		Conservation conservation1 = conservationConnector.getConservation(pos1, "T", "TA");
