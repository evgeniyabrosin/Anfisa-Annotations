...
public class ConservationTest extends AnfisaBaseTest {
	...
	public void testSimple() {
		...
		Conservation conservation1 = new ConservationData(source37).getConservation(pos1, "G", "T");
		...
		Conservation conservation2 = new ConservationData(source37).getConservation(pos2, "A", "C");
		...
		Conservation conservation3 = new ConservationData(source37).getConservation(pos3, "G", "C");
		...
		Conservation conservation4 = new ConservationData(source37).getConservation(pos4, "A", "G");
		...
		Conservation conservation5 = new ConservationData(source37).getConservation(pos5, "GGCAGCGCCA", "G");
		...
		Conservation conservation7 = new ConservationData(source37).getConservation(pos7, "A", "AACC");
	...
	public void testMulti() {
		...
		Conservation conservation1 = new ConservationData(source37).getConservation(pos1, "T", "TA");
		...
		Conservation conservation2 = new ConservationData(source37).getConservation(pos2, "A", "AT");
